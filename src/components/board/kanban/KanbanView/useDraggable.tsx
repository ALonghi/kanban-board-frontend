...
import {getDifference, mapAfterSwap, removePositionField,} from "../../../../utils/helpers";
...
export const useDraggable = (
    ...
    function handleDragEnd(props) {
        ...
        const itemMoved = itemMovedArray?.length > 0
            ? {...itemMovedArray[dragged.index], column_id: over.droppableId} as ITask
            : null;
