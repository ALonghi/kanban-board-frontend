...
import {Bars3BottomLeftIcon, InboxStackIcon, XMarkIcon,} from "@heroicons/react/24/outline";
            ...
            <Transition.Root show={sidebarOpen} as={Fragment}>
                ...
                >
                    ...
                    <div className="fixed inset-0 z-40 flex">
                        ...
                        >
                            <Dialog.Panel
                                className="relative flex w-full max-w-[80vw]  flex-1 flex-col bg-theme-600 pt-5 pb-4">
                                <Transition.Child
                                    as={Fragment}
