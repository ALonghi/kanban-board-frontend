...
const navigation = [
  ...
  { name: 'Jobs', href: '/', icon: FolderIcon, current: false },
];
  ...
  return (
    <div>
      <Transition.Root show={sidebarOpen} as={Fragment}>
        <Dialog as="div" className="relative z-40 md:hidden" onClose={setSidebarOpen}>
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-theme-700 pt-5 pb-4">
                <Transition.Child
                  as={Fragment}
      ...
      <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
        ...
        <div className="flex flex-grow flex-col overflow-y-auto bg-theme-700 pt-5">
          <div className="flex flex-shrink-0 items-center px-4">
            <img
              className="h-8 w-auto"
              src="https://tailwindui.com/img/logos/mark.svg?color=blue&shade=300"
